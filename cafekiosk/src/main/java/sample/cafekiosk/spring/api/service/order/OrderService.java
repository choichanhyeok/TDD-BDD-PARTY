...
public class OrderService {
    ...
    public OrderResponse createOrder(OrderCreateServiceRequest req, LocalDateTime registedDateTime){
    ...
    private static Map<String, Long> createCountingMapBy(List<String> stockProductNumbers) {
        return stockProductNumbers.stream() // 키가 프로덕트 넘버, 벨류가 카운팅이 되는 맵 생성
